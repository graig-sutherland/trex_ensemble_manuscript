...
\Title{Lagrangian Ensemble Forecasting in Coastal Environments}

% Author Orchid ID: enter ID or remove command
\newcommand{\orcidauthorA}{0000-0001-6109-9022} % Add \orcidA{} behind the author's name
%\newcommand{\orcidauthorB}{0000-0000-0000-000X} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Graig Sutherland $^{1}$\orcidA{}, Firstname Lastname $^{2}$ and Firstname Lastname $^{2,}$*}

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Graig Sutherland, Firstname Lastname and Firstname Lastname}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Environment and Climate Change Canada; graigory.sutherland@ec.gc.ca\\
$^{2}$ \quad Affiliation 2; e-mail@e-mail.com}

% Contact information of the corresponding author
\corres{Correspondence: graigory.sutherland@ec,gc,ca (F.L.)}
...
% Keywords
\keyword{Lagrangian; Forecast; Skill; Ensemble} 
...
Modelling the trajectories of material and objects at sea are a key component of making informed decisions to support Marine Emergency Response (MER) \cite{MER_guide}. MER covers environmental emergencies, such as marine oil spills <ref>, as well as drifting objects (e.g. lost shipping containers <ref>) or persons with a threat to life and property (e.g. search and rescue and/or vessles adrift at sea <ref>). Due to the time sensitive nature of these emergencies, trajectory modelling is reliant on operational environmental prediction systems which provide regular forecasts of the wind and surface currents.
...
%=====================================
\bibliography{jmse-sutherland.bib}
